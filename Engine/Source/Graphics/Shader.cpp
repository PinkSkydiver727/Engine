...
namespace loft { namespace graphics {
	...
	void Shader::setUniform2f(const GLchar* name, math::Vector2 vector)
	{
		glUniform2f(getUniformLocation(name), vector.x, vector.y);
	}
	void Shader::setUniform3f(const GLchar* name, math::Vector3 vector)
	{
		glUniform3f(getUniformLocation(name), vector.x, vector.y, vector.z);
	}
	void Shader::setUniform4f(const GLchar* name, math::Vector4 vector)
	{
